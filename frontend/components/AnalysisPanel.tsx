...
export default function AnalysisPanel({
  ...
  // dataset basics based on ACTIVE dataset
  const rowCount = currentRows.length;
  const columns =
    activeDataset?.columns && activeDataset.columns.length
        ...
        >
          ...
          >
            <div className="flex-1 overflow-y-auto px-4 pb-4 pt-3 space-y-5">
              ...
              <KPISection data={currentRows} columns={columns} />
          ...
          {chatOpen && (
            <>
              <div
                className={`w-[1px] bg-gray-200 relative hover:bg-blue-400 transition-colors cursor-col-resize z-10 flex items-center justify-center group ${
              ...
              >
                ...
                <div
                  className={`absolute w-5 h-8 bg-white border border-gray-200 rounded-full shadow-sm flex items-center justify-center transition-all z-30 ${
                    isResizing
